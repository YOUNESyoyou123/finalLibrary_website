...
window.location.reload("false")
   ...
   <nav className={`h-18 sticky top-0 bg-white shadow-md border-b `}>
        <div className="px-2 mt-2 flex justify-between">

        <div className="flex  ">
       <Link to="/" ><div className="flex"><img src={UniLogo} alt="UniLogo"   width={100}   className="pb-1 hidden sm:block "/> <h1 className="text-xl pt-4 text-red-600 max-sm:hidden lg:visible">BookCastle</h1> </div></Link> 
        ...
        <div className="sm:flex     sm:mt-4 hover:cursor-pointer	 sm:gap-4 font-semibold hidden ">
            ...
            <p className="hover:animate-pulse font-roboto hover:underline hover:underline-red hover:underline-offset-8 ease-out duration-600 px-1 text-text-lg	 font-medium  hover:text-red-700">Cart</p>
    ...
    <ul className="pt-3">
        ...
        <div className="sm:mt-4  sm:right-0  sm:flex sm:gap-6 flex   right-0 mt-2 gap-3">
             <img src={NotifiLogo} alt="Notification-logo  " className="pb-5" />
            <img src={CartLogo} alt="Cart-logo" className="h-6 mt-1" />

         {!cookies.access_token
            ?<Link to='/Login'><button className=" border-none px-5  mr-3 h-9  rounded-lg border-bg-red hover:ring-red-400 hover:ring-1 ease-out duration-300 hover:bg-white hover:text-black bg-[#B80000]  text-white cursor-pointer tracking-wide">Login</button></Link>
            :<>
